...
function LoginWithGoogle({ onSuccess }: LoginWithGoogleProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white p-8 rounded-xl border-2 border-emerald-200 shadow-xl">
        ...
        <button
          ...
          className="w-full py-4 px-6 bg-white border-2 border-gray-300 rounded-lg font-semibold text-gray-700 hover:bg-gray-50 transition flex items-center justify-center gap-3 shadow-sm hover:shadow-md mb-4"
        >
